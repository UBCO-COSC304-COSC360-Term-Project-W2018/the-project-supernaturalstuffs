...
<link href='https://fonts.googleapis.com/css?family=Almendra Display' rel='stylesheet'>
    ...
    <main>
      ...
      <!--Login Form-->
      <form name="login" id="log" method="post" action="/src/server/PHP/login.php" onsubmit="return checkLogin()">
        <fieldset>
          <legend>Login</legend>
          <div>
            <label>Email:</label>
          ...
          <div class="centered">
            <input type="button" onclick="location.href='#'" value="Forgot Password?" class="button" id="forgotPass"/>
          </div>
          <div>
          ...
          <div class="centered">
            <input type="button" onclick="location.href='createAccount.html'" value="Create Account" class="button"/>
          </div>
        </fieldset>
      </form>
    </main>
