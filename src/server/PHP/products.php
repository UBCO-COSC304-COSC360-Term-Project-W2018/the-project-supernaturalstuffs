   ...
   <body>
        ...
        */
                ...
                $type = "png";
								...
								echo	'<a href="individualProducts.php?pID='.$row['pID']."&pName=".$row['pName']."&price=".$row['price']."&description=".$row['description'].'"><img src = "data:image/'.$type.';base64, '.base64_encode($image).' alt=\"../images/ghostbusters-logo.png\"/></a>';
								echo	'<p>' . $row["pName"] . '</p>';
