				...
				<?php
						...
						echo('<p id="sortButton">Sort by</p>
							...
							foreach ($rows as $row) {
								...
								echo	'<a href="individualProducts.php?pID='.$row['pID']."&pName=".$row['pName']."&price=".$row['price']."&description=".$row['description'].'"><img src="../images/ghostbusters-logo.png" alt="productimage"/></a>';
								echo	'<p>' . $row["pName"] . '</p>';
